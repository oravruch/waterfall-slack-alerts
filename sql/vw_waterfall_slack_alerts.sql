-- Consolidated Waterfall Slack alert view for #ca-data-alerts
-- Deploy to: PROD_INCUBATION.FIN_OPS.VW_WATERFALL_SLACK_ALERTS

CREATE OR REPLACE VIEW PROD_INCUBATION.FIN_OPS.VW_WATERFALL_SLACK_ALERTS AS
